...
<head>
    ...
    <title>{{ translate('Driver_Level_List') }}</title>
...
<div class="container" id="printableTable">
    ...
    <table class="table table-borderless table-striped">
        ...
        <tr>
            ...
            <th class="text-uppercase text-primary">{{translate('total_earning_amount')}}</th>
            <th class="text-uppercase text-primary">{{translate('total_driver')}}</th>
        </tr>
        </thead>
        <tbody>
        @foreach($data as $key => $d)
            <tr>
                ...
                <td>{{$d['total_earning_amount']}}</td>
                <td>{{$d['total_driver']}}</td>
            </tr>
        @endforeach
