                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide px-4">
                            <div class="d-flex flex-column align-items-center gap-2 text-center">
                                ...
                                <p>{{ translate("When creating a level, need to prioritize defining the targets before the driver uses this level and points required for a driver to achieve that level. If there is a mismatch in setting these criteria, it may affect the driver's ability to reach the level.") }}</p>
                            </div>
                        </div>
                    </div>
