...
@section('title', translate('Edit_Customer_Level'))
    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="d-flex justify-content-between gap-3 align-items-center mb-4">
                <h2 class="fs-22 text-capitalize">{{ translate('edit_customer_level') }}</h2>
            ...
            <form action="{{ route('admin.customer.level.update', ['id' => $level->id]) }}" method="post"
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <p>{{translate('The Current Level setup automatically assigns customers the default level upon their initial app login')}}</p>
                    </div>
                    <div class="card-body">
                                        ...
                                        <div class="row g-4 justify-content-between align-items-center">
                                            <div class="col-sm-6 col-xl-5">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" name="name" value="{{$level->name}}" id="l_name"
                                                           class="form-control"
                                                ...
                                                <div class="row align-items-end g-4">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select class="js-select" name="reward_type" id="rewardType"
                                                                required>
                                                            <option
                                                                value="{{NO_REWARDS}}" {{ $level->reward_type == NO_REWARDS ? 'selected' : '' }}>{{translate('no_rewards')}}</option>
                                                            <option
                                                                value="{{WALLET}}" {{ $level->reward_type == WALLET ? 'selected' : '' }}>{{translate('wallet')}}</option>
                                                            <option
                                                                value="{{LOYALTY_POINTS}}" {{ $level->reward_type == LOYALTY_POINTS ? 'selected' : '' }}>{{translate('loyalty_points')}}</option>
                                                        </select>
                                                    </div>
                                                    <div id="rewardAmountDiv" class="col-sm-6">
                                                        <label id="rewardAmountLabel" for="rewardAmount"
                                                               class="mb-2">{{ $level->reward_type == WALLET ? translate('reward_amount') . ' (' . (session()->get('currency_symbol') ?? '$') . ')' : translate('reward_points') }}</label>
                                                        <input type="number" step=".01" name="reward_amount"
                                                               value="{{$level->reward_amount}}" max="999999999"
                                                    ...
                                                    <div class="check-toggle-item">
                                                        <label class="custom-checkbox">
                                                            <input type="checkbox" class="test"
                                                                   ...
                                                                   name="minimum_ride_complete"
                                                                   value="{{$level->targeted_ride>0?1:''}}" {{$level->targeted_ride>0?'checked':''}}>
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div>
                                                                            <input type="number"
                                                                                   ...
                                                                                   step="1" max="999999999"
                                                                                   value="{{$level->targeted_ride_point}}"
                                                    ...
                                                    <div class="check-toggle-item">
                                                        <label class="custom-checkbox">
                                                            <input type="checkbox" class="test" id="minimum_earn_amount"
                                                                   ...
                                                                   value="{{$level->targeted_amount>0?1:''}}" {{$level->targeted_amount>0?'checked':''}}>
                                                            {{translate('minimum_spend_amount')}}
                                                        </label>
                                                        <div class="check-toggle-content">
                                                            <div class="bg-input p-4 rounded ms-4">
                                                                <div class="row g-3">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <input type="number"
                                                                               ...
                                                                               step="1" max="999999999"
                                                                               value="{{$level->targeted_amount_point}}"
                                                    ...
                                                    <div class="check-toggle-item">
                                                        <label class="custom-checkbox">
                                                            <input type="checkbox" class="test"
                                                                   ...
                                                                   value="{{$level->targeted_cancel>0?1:''}}" {{$level->targeted_cancel>0?'checked':''}}>
                                                                ...
                                                                <div class="row g-3">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <input type="number"
                                                                               ...
                                                                               value="{{$level->targeted_cancel_point}}"
                                                    ...
                                                    <div class="check-toggle-item">
                                                        <label class="custom-checkbox">
                                                            <input type="checkbox" class="test"
                                                                   ...
                                                                   value="{{$level->targeted_review>0?1:''}}" {{$level->targeted_review>0?'checked':''}}>
                                                                ...
                                                                <div class="row g-3">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <input type="number"
                                                                               ...
                                                                               step="1" max="999999999"
                                                                               value="{{$level->targeted_review_point}}"
