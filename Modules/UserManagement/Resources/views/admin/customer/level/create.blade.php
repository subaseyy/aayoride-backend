...
@section('title', translate('Add_Customer_Level'))
    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="d-flex justify-content-between gap-3 align-items-center mb-4">
                <h2 class="fs-22 text-capitalize">{{ translate('add_customer_level') }}</h2>
            ...
            <div class="alert alert--primary d-flex align-items-center alert-dismissible gap-1 justify-content-center"
                ...
                <div class="w-50px flex-grow-1">
                    {{translate('At present, there is only one level available, which is the default level. When a customer logs in to the app for the first time, they will automatically be assigned the default level.')}}
                </div>
                <button type="button" class="btn-close" id="hintModal" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
            <form action="{{ route('admin.customer.level.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card">
                            ...
                            <div class="col-xl-9">
                                <div class="card mb-4">
                                    <div class="card-header pt-4 border-0 text-center">
                                        ...
                                        <p>{{translate('The customer will receive that reward amount while completing this level targets')}}</p>
                                    </div>
                                    <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-4">
                                                    ...
                                                    <div id="rewardAmountDiv" class="col-sm-6 d-none">
                                                        ...
                                                        <input type="number" step=".01" name="reward_amount"
                                                               value="{{old('reward_amount')}}" max="999999999"
                                                                ...
                                                                <div class="row g-3">
                                                                    <div class="col-sm-6">
                                                                        <input type="number" step=".01" min=".01"
                                                                               ...
                                                                               placeholder="{{ translate('minimum_spend_amount') }}">
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <input type="number"
...
@push('script')
    ...
    <script>
        ...
        $("#hintModal").on('click', function () {
            localStorage.setItem('customer-level-hint', true);
        });
        if (localStorage.getItem('customer-level-hint')) {
