<div class="tab-pane fade active show" id="transaction-pane" role="tabpanel">
    <div class="d-flex flex-wrap justify-content-between align-items-center mt-30 mb-3 gap-3">
        ...
        <div class="d-flex align-items-center gap-2">
            <span class="text-muted">{{translate('total_transaction')}} : </span>
            ...
            <div class="table-top d-flex flex-wrap gap-10 justify-content-between">
                <form action="javascript:;" method="GET"
                    ...
                    <div class="input-group search-form__input_group">
                        ...
                        <input type="search" name="search" value="{{$otherData['search']}}"
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            <li><a class="dropdown-item"
                                   href="{{route('admin.customer.transaction-export', ['id' => $commonData['customer']->id, 'file' => 'csv','search' => request()->input('search')])}}">{{translate('CSV')}}</a>
                            </li>
                            <li><a class="dropdown-item"
                                   href="{{route('admin.customer.transaction-export', ['id' => $commonData['customer']->id,'file' => 'excel','search' => request()->input('search')])}}">{{translate('excel')}}</a>
                            </li>
                        </ul>
                    </div>
                </div>
