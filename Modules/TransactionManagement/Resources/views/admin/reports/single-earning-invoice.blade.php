...
<head>
    ...
    <title>{{translate('earning_invoice')}}</title>
                    ...
                    <tr>
                        ...
                        <td class="text-right" style="padding:21px 8px;">
                            ...
                            <div class="text-right" style="font-size: 24px;font-weight:700;color:#000000;white-space:nowrap;">
                                {{getCurrencyFormat($data?->fee?->admin_commission??0)}}</div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="4" style="padding: 10px">
                            ...
                            <table class="table __subscribe-table table-borderless mt-3" style="color: rgb(105, 101, 101)">
                                ...
                                <tr>
                                    ...
                                    <th style="font-weight:500">
                                        <span>{{ translate('Commission Earning') }}</span>
                                    </th>
                                    <th style="font-weight:500">
                                        <span>{{ translate('Tax Collected') }}</span>
                                    </th>
                                    <th style="font-weight:500">
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 18px 10px;">
                                        <span>{{ getCurrencyFormat($data?->fee?->admin_commission-$data?->fee?->vat_tax) }}</span>
                                    </td>
                                    <td style="padding: 18px 10px;">
                                        <span>{{ getCurrencyFormat($data?->fee?->vat_tax) }}</span>
                                    </td>
                                    <td style="padding: 18px 10px;">
                                            <span class="__txt-nowrap">
                                                {{getCurrencyFormat($data?->fee?->admin_commission)}}
                                            </span>
                                    </td>
                                </tr>
                                </tbody>
