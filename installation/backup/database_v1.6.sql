...
CREATE TABLE `channel_conversations` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `convable_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `convable_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `channel_lists` (
  ...
  `channelable_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `coupon_setups` (
  ...
  `zone_coupon_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'custom',
  `customer_level_coupon_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'custom',
  `customer_coupon_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'custom',
  `category_coupon_type` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `min_trip_amount` decimal(8,2) NOT NULL DEFAULT '0.00',
...
(11, 'new_message', 'You got a new message from {userName}', 1, NULL, '2024-07-14 02:57:46'),
(12, 'payment_successful', '{paidAmount} payment successful on this trip by {methodName}.', 1, NULL, '2024-07-14 02:57:46'),
...
(39, 'bid_request_from_driver', 'Driver sent a bid request', 1, '2024-07-14 02:57:46', '2024-07-14 02:57:46'),
(40, 'bid_request_cancel_by_customer', 'Customer has canceled your bid request', 1, '2024-07-14 02:57:46', '2024-07-14 02:57:46'),
(41, 'fund_added_by_admin', 'Admin has added {walletAmount} to your wallet', 1, '2024-07-14 02:57:46', '2024-07-14 02:57:46'),
(42, 'level_up', 'You have completed your challenges and reached level {levelName}', 1, '2024-07-14 02:57:46', '2024-07-14 02:57:46'),
(43, 'vehicle_is_active', 'Your vehicle status has been activated by admin', 1, '2024-07-14 02:57:46', '2024-07-14 02:57:46'),
(44, 'driver_cancel_ride_request', 'Driver has canceled your ride', 1, '2024-07-14 02:57:46', '2024-07-14 02:57:46'),
(45, 'tips_from_customer', 'Customer has given the tips {tipsAmount} with payment', 1, '2024-07-14 02:57:46', '2024-07-14 02:57:46'),
(46, 'withdraw_request_rejected', 'Unfortunately, your withdrawal request has been rejected. {withdrawNote}', 1, '2024-07-14 02:57:46', '2024-07-14 02:57:46'),
(47, 'withdraw_request_approved', 'We are pleased to inform you that your withdrawal request has been approved. The funds will be transferred to your account shortly.', 1, '2024-07-14 02:57:46', '2024-07-14 02:57:46'),
(48, 'withdraw_request_settled', 'Your withdrawal request has been successfully settled. The funds have been transferred to your account.', 1, '2024-07-14 02:57:46', '2024-07-14 02:57:46'),
(49, 'withdraw_request_reversed', 'Your withdrawal request has been successfully settled. The funds have been transferred to your account.', 1, '2024-07-14 02:57:46', '2024-07-14 02:57:46'),
(50, 'customer_bid_rejected', 'We regret to inform you that your bid request for trip ID {tripId} has been rejected by the customer', 1, '2024-07-14 02:57:46', '2024-07-14 02:57:46'),
(51, 'legal_updated', 'We have updated our legal', 1, '2024-07-14 02:57:46', '2024-07-14 02:57:46');
