...
--
-- Host: localhost:3306
-- Generation Time: Apr 20, 2024 at 06:28 AM
...
CREATE TABLE `cancellation_reasons` (
  ...
  `cancellation_type` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `discount_setups` (
  ...
  `discount_type` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'percentage',
  `limit` int DEFAULT NULL,
  `start_date` date DEFAULT NULL,
  `end_date` date DEFAULT NULL,
  `rules` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `trip_requests` (
  ...
  `trip_cancellation_reason` longtext COLLATE utf8mb4_general_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `users` (
  ...
  `old_identification_image` longtext COLLATE utf8mb4_general_ci,
