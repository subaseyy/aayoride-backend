...
CREATE TABLE `activity_logs` (
  ...
  `logable_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `app_notifications` (
  ...
  `ride_request_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `area_bonus_setup` (
  ...
  `bonus_setup_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `area_coupon_setup` (
  `id` bigint UNSIGNED NOT NULL,
  `area_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `coupon_setup_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `area_discount_setup` (
  `id` bigint UNSIGNED NOT NULL,
  `area_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `discount_setup_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `area_pick_hour` (
  `id` bigint UNSIGNED NOT NULL,
  `area_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `pick_hour_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `banner_setups` (
  ...
  `banner_group` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `bonus_setups` (
  ...
  `user_level_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `amount_type` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'percentage',
  `bonus_type` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default',
...
CREATE TABLE `bonus_setup_vehicle_category` (
  `id` bigint UNSIGNED NOT NULL,
  `bonus_setup_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `vehicle_category_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `channel_conversations` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `convable_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `convable_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `channel_lists` (
  ...
  `channelable_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `coupon_setups` (
  ...
  `amount_type` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'percentage',
  `coupon_type` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default',
...
CREATE TABLE `driver_details` (
  ...
  `availability_status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unavailable',
...
CREATE TABLE `driver_time_logs` (
  ...
  `on_driving_time` double(23,2) NOT NULL DEFAULT '0.00',
  `idle_time` double(23,2) NOT NULL DEFAULT '0.00',
  `on_time_completed` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `late_completed` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `late_pickup` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `fare_biddings` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `trip_request_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `driver_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `fare_bidding_logs` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `trip_request_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `milestone_setups` (
  ...
  `customer_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `customer_level_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `driver_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `driver_level_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `thumbnail` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `banner` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `reward_type` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `reward_amount` decimal(30,2) NOT NULL,
  `start_date` date NOT NULL,
  `end_date` date NOT NULL,
  `challenge_type` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `parcels` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `trip_request_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sender_person_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sender_person_phone` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sender_address` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `receiver_person_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `receiver_person_phone` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `receiver_address` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `parcel_category_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `parcel_weight_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `parcel_fares_parcel_weights` (
  `id` bigint UNSIGNED NOT NULL,
  `parcel_fare_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `parcel_weight_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `parcel_category_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `payment_requests` (
  ...
  `hook` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `pick_hours` (
  ...
  `week_days` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `zone_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `transactions` (
  ...
  `trx_ref_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `trip_fares` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `zone_wise_default_trip_fare_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `zone_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `vehicle_category_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `base_fare` decimal(8,2) NOT NULL,
  `base_fare_per_km` decimal(8,2) NOT NULL,
...
CREATE TABLE `trip_requests` (
  ...
  `customer_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `driver_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vehicle_category_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `encoded_polyline` text COLLATE utf8mb4_unicode_ci,
  ...
  `type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `current_status` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  ...
  `map_screenshot` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `trip_request_coordinates` (
  ...
  `destination_address` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `intermediate_coordinates` text COLLATE utf8mb4_unicode_ci,
  ...
  `intermediate_addresses` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `trip_request_fees` (
  ...
  `waited_by` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `idle_fee` decimal(23,3) NOT NULL DEFAULT '0.000',
  `delay_fee` decimal(23,3) NOT NULL DEFAULT '0.000',
  `delayed_by` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `identification_type` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `identification_image` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  ...
  `user_type` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'customer',
...
CREATE TABLE `user_level_histories` (
  `id` bigint UNSIGNED NOT NULL,
  `user_level_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `vehicles` (
  ...
  `licence_plate_number` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `withdraw_requests` (
  ...
  `method_fields` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `note` text COLLATE utf8mb4_unicode_ci,
  `rejection_cause` text COLLATE utf8mb4_unicode_ci,
