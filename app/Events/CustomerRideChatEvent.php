...
class CustomerRideChatEvent implements ShouldBroadcast
{
    ...
    {
        return [
            new PrivateChannel("customer-ride-chat.{$this->tripRequest->id}"),
        ];
    }
    public function broadcastAs()
    {
        return "customer-ride-chat.{$this->tripRequest->id}";
    }
